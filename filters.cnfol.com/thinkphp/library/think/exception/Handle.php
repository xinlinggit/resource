...
class Handle
{
    ...
    protected function convertExceptionToResponse(Exception $exception)
    {
        ...
        /**start改装---记录404日志，方便正式服查看日志**/
        // ob_start();
        // extract($data);
        // $exception_tmpl=Config::get('exception_tmpl');
        // $path_str=explode(DS, $exception_tmpl);
        // if(end($path_str)!='think_exception.tpl'){
        //     $exception_tmpl=ROOT_PATH.'thinkphp/tpl/think_exception.tpl';
        // }
        // include $exception_tmpl;
        // $content  = ob_get_clean();
        // \cnfol\Tools::err_html($content);
        /**end改装---记录404日志，方便正式服查看日志**/
