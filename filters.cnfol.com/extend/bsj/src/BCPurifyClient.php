 ...
 */
require_once(EXTEND_PATH."bsj".DS."src".DS."config".DS."Cfg.php");
require_once(EXTEND_PATH."bsj".DS."src".DS."BCPurifyItem.php");
require_once(EXTEND_PATH."bsj".DS."src".DS."BCPurifyResult.php");
require_once(EXTEND_PATH."bsj".DS."src".DS."lib".DS."BCLogger.php");
require_once(EXTEND_PATH."bsj".DS."src".DS."lib".DS."BCClientProxy.php");
